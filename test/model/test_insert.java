...
public class test_insert {
	...
	public static void main(String[] args) {
		...
		dao.create(SqlVar.class, true);
		dao.create(SqlParam.class, true);
		testSaveContent(dao);
	}
//select t.userinfoid 主键, t.truename 姓名, addDate 添加时间, addIp from user$info t
	public static void testSaveContent(NutDao dao){
		SqlContent c = new SqlContent(dao);
		c.save("测试", "select t.userinfoid 主键, t.truename 姓名, addDate 添加时间, addIp from user$info t where t.truename = @truename");
	}
